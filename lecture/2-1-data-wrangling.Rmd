...
80% of the work - [**Data preparation** accounts for about 80% of the work of data scientists](https://www.forbes.com/sites/gilpress/2016/03/23/data-preparation-most-time-consuming-least-enjoyable-data-science-task-survey-says/#6a089d126f63)
...
# WHY data cleaning is a crucial step {.bigger .incremental}
...
2. Example 2: Importing data from an Excel spreadsheet

([RetailSales2018.xlsx](https://xiaorui.site/Data-Mining-Business-Analytics/lecture/data/RetailSales2018.xlsx)); ([RetailSales2018_clean.xlsx](https://xiaorui.site/Data-Mining-Business-Analytics/lecture/data/RetailSales2018_clean.xlsx))
...
# Learn about the data  { .bigger .incremental}
...
# Data Cleaning { .bigger .incremental}
...
- `na.omit()` : Removes any rows that contain at least one NA.
...
- `duplicated()`: Identifies duplicate values or rows, marking all but the first occurrence as TRUE.
