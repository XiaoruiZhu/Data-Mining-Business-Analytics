...
> - 1. headers: A single hashtag: first-level header. Two hash tags, `##`, creates a second-level header, and so on.
...
> - You can generate three types of files as the report: HTML/pdf/word and have them popped-up. 

> - PS: the pdf file generating process require LaTex (such as [MikTex](https://miktex.org/)) installed and your codes do not have bugs :-) 
