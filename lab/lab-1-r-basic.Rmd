---
title: "Lab1: Practice R Basic commands"
output:
  html_document: 
    fig_caption: yes
    number_sections: no
...
In this lab, we will practice some simple `R` commands. The best way to learn a new language is to try out the commands. 

I recommend that you run `R` within an integrated development environment (IDE) such as `RStudio`, which can be freely downloaded from `http://rstudio.com`
...
Download Dataset: [Auto.data](https://xiaorui.site/Data-Mining-Business-Analytics/lab/data/Auto.data)

Download csv Dataset: [Auto.csv](https://xiaorui.site/Data-Mining-Business-Analytics/lab/data/Auto.csv)
